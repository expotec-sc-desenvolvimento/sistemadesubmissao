        ...
        try {
            ...
            if (strtotime($prazo)>=strtotime($dataAtual)) {
                if (Avaliacao::atualizarAvaliacao($idAvaliacao, $novoAvaliador,1,$prazo)) {
                    ...
                    emailAtualizacaoAvaliacao(Submissao::retornaDadosSubmissao(Avaliacao::retornaDadosAvaliacao($idAvaliacao)->getIdSubmissao()), $prazo, UsuarioPedrina::retornaDadosUsuario($novoAvaliador)->getEmail());
