<?php
    ...
    require_once dirname(__FILE__) . '/../funcoes/funcoes.php';
    require_once dirname(__FILE__) . '/../classes/EnviarEmail.php';
    require_once dirname(__FILE__) . './varGlobais.php';
    
    
    require_once dirname(__FILE__) . '/../classes/Area.php';
    require_once dirname(__FILE__) . '/../classes/AreaEvento.php';
    ...
    require_once dirname(__FILE__) . '/../classes/UsuariosDaSubmissao.php';
    
    
    require_once dirname(__FILE__) . '/../dao/AreaDAO.php';
